...
function main(): void {
    ...
    test("3.0 splice", splice(list(["a", "b", "c"]), 0, list(["d", "e", "f"])), list(["d", "e", "f", "a", "b", "c"]));
    test("3.1 splice", splice(list(["a", "b", "c"]), 1, list(["d", "e", "f"])), list(["a", "d", "e", "f", "b", "c"]));
    test("3.2 splice", splice(list(["a", "b", "c"]), 2, list(["d", "e", "f"])), list(["a", "b", "d", "e", "f", "c"]));
    test("3.3 splice", splice(list(["a", "b", "c"]), 3, list(["d", "e", "f"])), list(["a", "b", "c", "d", "e", "f"]));
    
    // Requirement 4 - swapBack
    // TODO: Come up with your own tests for the swapBack function.
    test("4.0 swapBack", swapBack(list(["a", "b", "c", "d"]), 1), list(["a", "c", "b", "d"]));
